...
async function sendGetReportRequestAsync(url, options,reportIdVal){
    let promise = () => { return new Promise(
        (resolve, reject) => {
            request(url, options,function (error, response, body){
                ...
                if(body == ""){
                    console.log('error: no report with id: ' + reportIdVal + " in group with id: " + config.workspaceId);
                    reject('error: no report with id: ' + reportIdVal + " in group with id: " + config.workspaceId);
                }
                try{
...
async function sendGenerateEmbedTokenRequestAsync(url, options,reportIdVal){
    console.log(options)
    let promise = () => { return new Promise(
        (resolve, reject) => {
            request(url, options,function (error, response, body){
                ...
                try{
                    ...
                    console.log('generated tokennn');
                    console.log(generateEmbedTokenRes);
                    if(reportIdVal){
