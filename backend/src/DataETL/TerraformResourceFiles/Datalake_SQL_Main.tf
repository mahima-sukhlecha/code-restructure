		...
		"resources": [{
			...
			},
            {
                ...
                "properties": {
                  "type": "SqlServer",
                  "typeProperties": {
                     "connectionString": "[concat('Data Source=', parameters('SQLServerName'),';Initial Catalog=',parameters('SQLDatabasename'),';User ID=',parameters('SQLUsername'),';integrated security=False;')]",
